...
static void addLinkBefore(LinkedList* list, Link* link, TYPE value);	// Adds a new link with the given value before the given link and increments the list's size
static void removeLink(LinkedList* list, Link* link);					// Removes the given link from the list and decrements the list's size
